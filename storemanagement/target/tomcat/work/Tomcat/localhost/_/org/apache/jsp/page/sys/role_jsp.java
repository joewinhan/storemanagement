 ...
 * Generated at: 2020-12-30 15:55:13 UTC
...
public final class role_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t$('#role_edit_dialog').dialog({    \r\n");
      out.write("\t    title: '分配权限',    \r\n");
      out.write("\t    width: 600,    \r\n");
      out.write("\t    height: 300,    \r\n");
      out.write("\t    closed: false,    \r\n");
      out.write("\t    cache: false,    \r\n");
      out.write("\t    href: 'page/sys/privilege.jsp',    \r\n");
      ...
      out.write("\t\t\t\t//弹出窗口\r\n");
      out.write("\t\t\t\t$('#role_add_dialog').dialog({    \r\n");
      out.write("\t\t\t\t    title: '添加角色',    \r\n");
      out.write("\t\t\t\t    width: 400,    \r\n");
      out.write("\t\t\t\t    height: 200,    \r\n");
      out.write("\t\t\t\t    closed: false,    \r\n");
      out.write("\t\t\t\t    cache: false,    \r\n");
      out.write("\t\t\t\t    href: 'page/sys/role_add.jsp',    \r\n");
      out.write("\t\t\t\t    modal: true,\r\n");
      out.write("\t\t\t\t});\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t},'-',{\r\n");
      ...
      out.write("    \t\t\t\t$.messager.confirm('确认','您确认要删除选中的记录吗?',function(r){    \r\n");
      out.write("\t    \t\t\t    if (r){    \r\n");
      out.write("\t    \t\t\t    \tvar arr = $('#role_table').datagrid(\"getSelections\")\r\n");
      out.write("\t\t\t    \t\t\tvar ids = \"\";\r\n");
      out.write("\t\t\t    \t\t\tfor(var i in arr){\r\n");
      out.write("\t\t\t    \t\t\t\tif(i == arr.length-1){\r\n");
      out.write("\t\t\t    \t\t\t\t\tids += arr[i].id;\r\n");
      out.write("\t\t\t    \t\t\t\t}else{\r\n");
      out.write("\t\t\t    \t\t\t\t\tids = ids + arr[i].id+\",\";\r\n");
      out.write("\t\t\t    \t\t\t\t}\r\n");
      out.write("\t\t\t    \t\t\t}\r\n");
      out.write("\t\t\t    \t\t\t$.getJSON(\"page/deleteRole\",{ id: ids}, function(data){\r\n");
      out.write("\t\t\t\t\t\t\t\tif(data.status == 200){\r\n");
      out.write("\t\t\t\t\t\t\t\t\talert(data.msg);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$('#users_table').datagrid('reload');\r\n");
      out.write("\t\t\t\t\t\t\t\t}\r\n");
      out.write("\t\t\t    \t\t\t});  \r\n");
      out.write("\t    \t\t\t    }    \r\n");
      out.write("\t    \t\t\t});\r\n");
      out.write("    \t\t\t}else{\r\n");
      out.write("    \t\t\t\t$.messager.alert('系统消息','<b style=\"color:red\">你还没有选择记录呢！</b>'); \r\n");
      out.write("    \t\t\t}\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t},'-',{\r\n");
      ...
      out.write("\t\t\t\t\t    closed: false,    \r\n");
      out.write("\t\t\t\t\t    cache: false,    \r\n");
      out.write("\t\t\t\t\t    href: 'page/sys/role_edit.jsp',    \r\n");
      out.write("\t\t\t\t\t    modal: true,\r\n");
      out.write("\t\t\t\t\t    onLoad:function(){\r\n");
      out.write("\t\t\t\t\t    \t$(\"#role_edit_form :text:eq(0)\").val($(\"#role_table\").datagrid(\"getSelected\").name);\r\n");
      out.write("\t\t\t\t\t    \t$(\"#role_edit_form :text:eq(1)\").val($(\"#role_table\").datagrid(\"getSelected\").status);\r\n");
      ...
      out.write("<div id=\"role_add_dialog\"></div> \r\n");
      out.write("<div id=\"role_edit_dialog\"></div>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
